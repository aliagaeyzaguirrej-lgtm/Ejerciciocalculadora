class Cliente:  # Las clases siempre empiezan con Mayúscula por convención
    def __init__(self, rut, nombre, apellido, monto_de_apertura):
        self.nombre = nombre
        self.apellido = apellido
        self.rut = rut
        self.monto_de_apertura = monto_de_apertura
        self.contraseña = None  # Se inicializa vacío
    ...
    def verificar_password(self, intento):
        # Simplificamos el if/else devolviendo directamente la comparación
        return self.contraseña == intento

# El diccionario y la función van FUERA de la clase
registro_clientes = {}
